module.exports.buildFragmentInMainAdditions = (options) ->
	result = ''
...
module.exports.buildFragmentPreMainAdditions = (options) ->
	result = ''
...
fragFXAA = ->
	return '
		...
		vec4 colFxaa = fxaa(tColor, fragCoord, texSize, v_rgbNW, v_rgbNE, v_rgbSW, v_rgbSE, v_rgbM);\n
		col = colFxaa.rgb;\n
	'
