...
describe("Brick", () => {
  ...
  it("should return the right neighbors", () => {
    ...
    grid.forEachVoxel(voxel => new NewBrick([voxel]))
    ...
    return expect(nZp.has(vZp.brick)).to.equal(true)
  })
  ...
  it("should return the right connectedBricks", () => {
    ...
    let connectedBricks = v0.brick.connectedBricks()
    ...
    const v2 = grid.setVoxel({x: 0, y: 0, z: 2})
