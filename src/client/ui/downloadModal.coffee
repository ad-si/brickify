...
module.exports.getModal = (globalConfig) ->
	html = "
    ...
    <div class=\"modal-dialog\">
      <div class=\"modal-content\">
        ...
        <div class=\"modal-body\">
          ...
          <p>Select the stud size that works best for your 3d printer. If you
 don't know the size, download and print the&nbsp;
<a  href=\"/download/testStrip.zip\">test
	strip</a>.</p>
	<center>
	<img src=\"/img/testStrip.png\" width=\"300\" />
          </center>
	<p>To connect LEGO studs into the test strip, this size works best:
<select id=\"holeSizeSelect\" class=\"form-control\"/></p>
          <p>To connect test strip studs into LEGO bricks, this size works best:
          <select id=\"studSizeSelect\" class=\"form-control\"/></p><br />
	...
	<h4 class=\"disabled\">Download Instructions</h4>
        ...
        <div class=\"modal-footer\">
          <button data-dismiss=\"modal\" class=\"btn btn-primary disabled\">Close</button>
	</div>
      </div>
	</div>
  </div>"
	...
	addOptions $studSizeSelect, 4, 0
	$holeSizeSelect = $modal.find '#holeSizeSelect'
	addOptions $holeSizeSelect, 4, 0
