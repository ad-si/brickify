...
class Polygon {
  ...
  classifySide ( polygon ) {
    let i; let vertex; let classification
    let num_positive = 0
    let num_negative = 0
  ...
  splitPolygon ( polygon, coplanar_front, coplanar_back, front, back ) {
    ...
    if ( classification === COPLANAR ) {
      ...
      let vertice_count
      let i; let j; let ti; let tj; let vi; let vj
      let t; let v
      const f = []
      const b = []
...
class Node {
  ...
  invert () {
    let i; let polygon_count; let temp
...
export default class ThreeBSP {
  constructor (geometry) {
    ...
    let i; let _length_i
    let face; let vertex; let faceVertexUvs; let uvs
    let polygon
    const polygons = []
    let tree
  ...
  toGeometry () {
    ...
    let polygon; let polygon_vertice_count
    const vertice_dict = {}
    let vertex_idx_a; let vertex_idx_b; let vertex_idx_c
    let vertex; let face
    let verticeUvs
